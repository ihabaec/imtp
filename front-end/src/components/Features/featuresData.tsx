...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Our Image Forgery Detection Model and Steganography Detection Model are designed to help startups and businesses secure their digital assets. Whether you're building a platform for image verification or ensuring data integrity, these models provide cutting-edge solutions to detect tampered images and hidden steganographic data.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Both models are built with state-of-the-art deep learning architectures, ensuring high accuracy and reliability. The Image Forgery Detection Model uses convolutional neural networks (CNNs) to identify tampered regions, while the Steganography Detection Model leverages advanced algorithms to detect hidden data within images.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Both models are free and open-source, making them accessible to developers and researchers worldwide. Contribute to the project, suggest improvements, or use the models as a foundation for your own innovations",
  }
];
